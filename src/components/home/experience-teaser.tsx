    ...
    <div>
      <div className="mb-8 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h2 className="max-w-lg font-[family-name:var(--font-display)] text-[length:var(--text-h1)] font-semibold tracking-tight">
            {title}
          </h2>
        </div>
      ...
      <div className="grid gap-4">
        {items.map((item) => (
          <article
            ...
            className="grid gap-3 rounded-[var(--radius-lg)] border border-[var(--surface-border)] bg-[var(--surface)] p-5 shadow-[var(--shadow-card)] sm:grid-cols-12 sm:items-start"
          >
